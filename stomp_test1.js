...
const client = new StompJs.Client({
    brokerURL: 'ws://localhost:8080/chat?token='+
        'eyJhbGciOiJIUzI1NiJ9.eyJuaWNrX25hbWUiOiLmtIvmtIsyMjIyIiwiaXNzIjoiYmFkIiwiaWQiOiI2MTA0ODU4MTYzNjc1MTc2OTYiLCJleHAiOjE2MjU3MzkyMjYsImlhdCI6MTYyNTcxNzYyNn0.FTb9hSFg-x0-V1MAW-o9QcZNuVZjcO3vx6azmdJsc4w',
    connectHeaders: {
